...
/**
 * The Logger class allows for the creation and storing of logs, along with
 * displaying logs during runtime and post-runtime.
 * 
 * @author Viraj Shah
 */
public class Logger {
	...
	/**
	 * A preference which allows the Logger class to print logs once they are
	 * created
	 */
	public static boolean printLogsWhenCreated = false;

	/**
	 * Create a new log. If Logger.printLogsWhenCreated is true, then the log will
	 * also be printed
	 *
	 ...
	 *
	 * @param message        The message to be added to the set of logs
	 * @param allowedToPrint Whether this method call should print out the message
	 *                       upon creation
	 */
	...
	public static void clearAllLandingLogs() {
		landings.clear();
	}
}
