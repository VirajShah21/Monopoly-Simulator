...
/**
 * The LandingLog class contains the structure for recording every position of a player
 */
public class LandingLog {
     ...
     * @param rentDue The amount of money which was payed in rent as a result of landing on the tile
     */
